...
export default function Header() {
  return (
    <header className="h-[12.5%] md:px-20 flex flex-row justify-between items-center bg-accent-secondary shadow-md">
      <img src="/Cornhusker_logo.png" alt="Logo" className="h-full" />
      
      <div className='items-center mr-40'>
        <h1 className="text-5xl self-center font-medium tracking-widest text-white">
          Cornhusker Airways
        </h1>
      </div>
